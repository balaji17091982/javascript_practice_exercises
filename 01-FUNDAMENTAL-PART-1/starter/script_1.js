...
// const now = 2021;
// const job = 'engineer';
// const introduction = "I'm " + firstName + " a " + (now - birthYear) + " year old " + job;
// console.log(introduction);
// const introductionTemplateLiterals = `I'm ${firstName} a ${now-birthYear} year old ${job}`;
// console.log(introductionTemplateLiterals)
// console.log(`string printed using backticks`);
// console.log(`sting 
// with
// multiple lines
...
// } else {
//     console.log(`You cannot start driving license. Years Left ${18-age}`);
// }